        ...
        <form action="{{ route('pharmacy.medications.update', $medication->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 mb-6 pt-4 border-t border-slate-100">
                ...
                <div>
                    ...
                    <input type="number" id="original_price" name="original_price" value="{{ old('original_price', $medication->original_price ? (int)$medication->original_price : '') }}" min="0" dir="ltr" placeholder="12000" oninput="calculateDiscount()"
                ...
                <div>
                    ...
                    <input type="number" id="price" name="price" value="{{ old('price', (int)$medication->price) }}" required min="0" dir="ltr" oninput="calculateDiscount()"
                ...
                <div>
                    ...
                    <input type="number" id="discount_percent" name="discount_percent" value="{{ old('discount_percent', $medication->discount_percent) }}" min="0" max="100" placeholder="20" dir="ltr" oninput="calculateFromPercent()"
                        class="w-full text-right px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 text-sm font-medium text-slate-700">
                </div>
