...
class _AdminXRaysScreenState extends State<AdminXRaysScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final filteredPending = _filterList(pendingXRays);
    final filteredApproved = _filterList(approvedXRays);
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'گەڕان بەپێی ناوی سەنتەر، ناونیشان یان مۆبایل...',
          ...
          Expanded(
            child: _isLoading
                ...
                : TabBarView(
                    controller: _tabController,
                    children: [
                      _buildXRayList(filteredPending, isPending: true),
                      _buildXRayList(filteredApproved, isPending: false),
                    ],
                  ),
          ),
        ],
